  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        // Dark Frost Base Layer overlay to blend everything smoothly
        Positioned.fill(
          child: Container(
        ...
        // Static Wave equivalent (Custom SVG/Path or Simple Container styling)
        // A gentle curved gradient to simulate the wave aesthetic without movement
        Positioned(
          bottom: 0,
          left: 0,
          right: 0,
